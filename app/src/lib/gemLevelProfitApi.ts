...
export type GemProfitResponseItemRecipeName = 'level_corrupt_add_level_sell' | 'level_sell' | 'level_vendor_quality_sell' | 'level_vendor_quality_level_sell' | 'quality_level_sell' | 'vendor_buy_corrupt_level_sell_vaal' | 'vendor_buy_level_sell' | 'vendor_buy_level_vendor_quality_level_sell' | 'vendor_buy_level_vendor_quality_sell' | 'vendor_buy_quality_level_sell';
